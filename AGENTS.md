# AGENTS.md — règles de travail sur WorldPaint
...
- `docs/regions.md` — les régions naturelles : comment le lieu décide du
  ...
  ancre.
- `src/layers/AGENTS.md` et `src/terrain/AGENTS.md` — la carte fine de ces deux
...
| du mobilier (bord de route, parcelle, carrefour, repère) | `layers/furniture/` — voir `src/layers/AGENTS.md` |
...
| une couche (routes, bâti, végétation, herbe…) | `src/layers/AGENTS.md` d'abord |
...
- ce qui relève de la décision d'architecture ou du contexte général va dans
  `AGENTS.md` ou `docs/`, pas dans un fichier source.
...
Un `AGENTS.md`, un en-tête de module ou une page de `docs/` ne racontent jamais
