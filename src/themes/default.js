...
/**
 * Ce qui fait la silhouette d'une haie, par famille, en plus de sa section
 * (`furnitureKit`). La géométrie exécute ces cotes (`hedgeGeometry`).
 */
export const HEDGE_SHAPES = {
  /** Haie de bocage. */
  hedge: {
    /**
     * Longueur du bout arrondi, en mètres, en quart d'ellipse
     * (`hedgeGeometry.hedgeEndTaper`). À peu près la largeur de la haie :
     * c'est le rayon d'un bout taillé.
     */
    noseM: 1.1,
